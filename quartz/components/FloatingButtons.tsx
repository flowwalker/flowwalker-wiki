    ...
    <>
      <div class="floating-buttons">
        <button
          ...
          id="fb-readermode-btn"
          title="切换侧栏"
          aria-label="切换侧栏"
          onclick="document.getElementsByClassName('readermode')[0]?.click()"
        >
          <svg class="fb-icon-panel-both" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <rect x="3" y="3" width="18" height="18" rx="2"/>
            <line x1="9" y1="3" x2="9" y2="21"/>
            <line x1="15" y1="3" x2="15" y2="21"/>
          </svg>
          <svg class="fb-icon-panel-left" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <rect x="3" y="3" width="18" height="18" rx="2"/>
            <line x1="9" y1="3" x2="9" y2="21"/>
          </svg>
        </button>
        ...
        <a
          ...
          href="https://flowwalker.github.io"
          target="_blank"
          rel="noopener"
          title="归返本山→主博客"
          aria-label="归返本山→主博客"
...
/* reader mode icon toggle */
.floating-buttons .fb-icon-panel-both { display: block; }
.floating-buttons .fb-icon-panel-left { display: none; }
:root[reader-mode="on"] .floating-buttons .fb-icon-panel-both { display: none; }
:root[reader-mode="on"] .floating-buttons .fb-icon-panel-left { display: block; }
